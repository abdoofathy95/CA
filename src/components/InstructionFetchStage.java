...
public class InstructionFetchStage {
	public static int currentPC; // at beginning of a program execution (after reading the file containing the program), set this to zero
	public static String currentInstruction;
	

public static void startNextStage() {
	InstructionDecodeStage.init();
}
